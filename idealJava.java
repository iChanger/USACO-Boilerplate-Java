...
class idealJava {
    public static void main (String [] args) throws IOException {
        ...
        //StringTokenizer st = new StringTokenizer(f.readLine()); //Add only if a specific line in your input has spaces between what you want to input
        //int firstInt = st.nextToken();
